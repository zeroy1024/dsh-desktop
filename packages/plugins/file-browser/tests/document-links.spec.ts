...
import { classifyAnchorHref, classifyImageSrc, resolveRelativePath } from '../src/client/document-links.ts'
import type { DocumentPathContext } from '../src/client/document-links.ts'

/** 工作区文件 `docs/guide/intro.md` 的上下文（baseDir = docs/guide）。 */
const workspace: DocumentPathContext = { baseDir: 'docs/guide', allowRootRelative: true }
/** 外部绝对文件 `/Users/z/notes/readme.md` 的上下文（拒绝根相对）。 */
const external: DocumentPathContext = { baseDir: '/Users/z/notes', allowRootRelative: false }
...
describe('classifyAnchorHref', () => {
  ...
  it('带片段的相对文档链接 → document + fragment', () => {
    expect(classifyAnchorHref('docs/x.md#sec', { baseDir: '', allowRootRelative: true }))
